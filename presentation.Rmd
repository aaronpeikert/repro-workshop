...
```{r, echo=FALSE}
link <- "https://github.com/aaronpeikert/repro-workshop"
```
...
.optional[Suppress all code in output with: `knitr::opts_chunk$set(echo = FALSE)`]
...
.optional[Add any package of your liking to any Rmd and `repro::automate()`]
...
.todo[Delete `inflation.pdf` terminal (`Alt + Shift + M`) and type `make`]

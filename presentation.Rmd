...
author: 
  - "Aaron Peikert"
date: 'LMU Open Science Center | `r Sys.Date()`'
output:
...
## What would I know about reproducible research?
...
https://rstudio.cloud/content/4467593
---
...
```{r, eval=FALSE}
usethis::create_github_token(description = "Token for Repro Workshop 2023 LMU Open Science Center")
```
...
# Open science: longterm perspektive
...
.todo[~~Commit and push~~.] ← Has Aaron removed the bug?

...
If we instead correlate average and peak simultaneous gamers for each game separate and then average these correlations, we get a within game correlation of `r round(within_cor, 4)` (remember this is a somewhat crude and a real multilevel/mixed effect model would be state of the art).

...
The idea for the data stems from [tidytuesday initiative](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-03-16/readme.md) [@tidytuesday]; the data was scraped for [kaggle](https://thislinkdoesnotwork.error) from [steamcharts.com](https://steamcharts.com/).

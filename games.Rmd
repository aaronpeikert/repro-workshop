...
The the idea for the data stems from the [tidytuesday initiative](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-03-16/readme.md); the data was scraped for [kaggle](https://www.kaggle.com/michau96/popularity-of-games-on-steam) from [steamcharts.com](https://steamcharts.com/).

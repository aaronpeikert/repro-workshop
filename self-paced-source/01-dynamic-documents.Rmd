...
For everything else we are missing the time and there are simply to many different skill levels for R programming.
...
Sorry, did I confuse you with that?
Don't worry, we're in this together.
Let us break it down.
What components do we need to bundle neatly together to archive automated reproduibility?
...
We have already dealt with code and data.
If you want to read up on it again, go back to the beginning of this chapter.

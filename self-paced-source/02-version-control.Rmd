...
```{r results='asis', echo = FALSE}
addinfoPAT <- generate_additionalinfo(links$addinfos$PAT,
                                      "Personal Access Tokens (PAT)",
                                      "Personal Access Tokens (PATs) work just like passwords—they’re digital keys that let you log in securely. Instead of using your full password, you use a PAT, which only grants the specific access you need, so if it’s ever compromised, the potential damage is limited. Click on this box for additional details and to visit the official documentation.")
cat(addinfoPAT)
```
...
<video class="welcome_vid" controls muted>
  <source src="https://github.com/aaronpeikert/repro-workshop/releases/latest/download/3Version.Control.mp4" type="video/mp4">

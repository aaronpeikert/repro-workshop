...
But a even better idea than to use the resources here is to start a small project on GitHub together with a friend.
...
Also many thanks from my developers Aaron Peikert and Hannes Diemerling.

If you have any questions and/or comments, here is the link to the corresponding document:

[<span style="color:orange">Feedback</span>](`r links$general$feedback`)
